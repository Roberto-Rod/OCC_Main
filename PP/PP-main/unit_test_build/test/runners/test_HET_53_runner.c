...
extern void test_LongButtonPressStartedInIdleDoesNotSwitchTheDeviceOffDuringInitialPumpDownOrTherapyDelivery(void);
extern void test_LongButtonPressStartedInIdleDoesNotSwitchTheDeviceOffDuringInitialPumpDownOrTherapyDeliveryAfterGoingFromLeakToIdle(void);
...
int main(void)
{
  UnityBegin("test_HET_53.c");
  RUN_TEST(test_LongButtonPressStartedInIdleDoesNotSwitchTheDeviceOffDuringInitialPumpDownOrTherapyDelivery, 76);
  RUN_TEST(test_LongButtonPressStartedInIdleDoesNotSwitchTheDeviceOffDuringInitialPumpDownOrTherapyDeliveryAfterGoingFromLeakToIdle, 171);
