...
extern void test_PeriodicallyRefreshLedsAndPwmOutputPinsSoThatNoiseDoesNotPreventTherapyDelivery(void);
...
int main(void)
{
  UnityBegin("test_HET_15.c");
  RUN_TEST(test_PeriodicallyRefreshLedsAndPwmOutputPinsSoThatNoiseDoesNotPreventTherapyDelivery, 95);
