...
extern void test_SwitchTheDeviceOffWithLongButtonPressStartedInLeakErrorConditionAndDetectedInTherapyDelivery(void);
...
int main(void)
{
  UnityBegin("test_HET_67.c");
  RUN_TEST(test_SwitchTheDeviceOffWithLongButtonPressStartedInLeakErrorConditionAndDetectedInTherapyDelivery, 77);
