...
extern void test_RestartTheTherapyWithShortButtonPressFromLeakErrorCondition(void);
...
int main(void)
{
  UnityBegin("test_HET_61.c");
  RUN_TEST(test_RestartTheTherapyWithShortButtonPressFromLeakErrorCondition, 76);
