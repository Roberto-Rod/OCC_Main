...
extern void test_CompleteIctPostAndCheckTheEepromIsUnchangedThenRestartDeviceSkipPostAndCheckTheEepromIsStillUnchanged(void);
...
int main(void)
{
  UnityBegin("test_HET_68.c");
  RUN_TEST(test_CompleteIctPostAndCheckTheEepromIsUnchangedThenRestartDeviceSkipPostAndCheckTheEepromIsStillUnchanged, 99);
