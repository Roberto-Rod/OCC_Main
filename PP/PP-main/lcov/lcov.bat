...
set path=%path%;C:\MinGW\msys\1.0\bin\perl.exe;c:\windows\system32;\C:\MinGW\bin;C:\MinGW\msys\1.0\bin

:: Full dirname of current executable
set idir=%~dp0
set perl=C:\MinGW\msys\1.0\bin\perl.exe
set sourceDir=../sourcePico
...
%perl% %idir%/lcov.perl --extract %outputDir%/lcov.info "*/sourcePico/*" -o %outputDir%/lcov-sanitised.info
