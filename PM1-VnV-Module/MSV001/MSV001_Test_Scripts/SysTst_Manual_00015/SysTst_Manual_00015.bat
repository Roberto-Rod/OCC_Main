...
if not exist "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00015" mkdir "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00015" echo Creating directory... 
set LOG_FILE_ROOT="C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00015\SysTst_Manual_00015
:: Get date parts
...
echo Running test script SysTst_Manual_00015 from MSV001 test protocol
python "C:\Temp\MSV001\MSV001_Test_Scripts\SysTst_Manual_00015\SysTst_Manual_00015.py"
pause
