...
if not exist "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00006" mkdir "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00006"
set LOG_FILE_ROOT="C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00006\SysTst_Manual_00006
:: Get date parts
...
echo Running test script SysTst_Manual_00006 from MSV001 test protocol
python "C:\Temp\MSV001\MSV001_Test_Scripts\SysTst_Manual_00006\SysTst_Manual_00006.py"
pause
