...
if not exist "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00005" mkdir "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00005"
set LOG_FILE_ROOT="C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00005\SysTst_Manual_00005
:: Get date parts
...
echo Running test script SysTst_Manual_00005 from MSV001 test protocol
python "C:\Temp\MSV001\MSV001_Test_Scripts\SysTst_Manual_00005\SysTst_Manual_00005.py"
pause
