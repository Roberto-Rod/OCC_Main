...
if not exist "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00003" mkdir "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00003"
set LOG_FILE_ROOT="C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00003\SysTst_Manual_00003
:: Get date parts
...
echo Running test script SysTst_Manual_00003 from MSV001 test protocol
python "C:\Temp\MSV001\MSV001_Test_Scripts\SysTst_Manual_00003\SysTst_Manual_00003.py"
pause
