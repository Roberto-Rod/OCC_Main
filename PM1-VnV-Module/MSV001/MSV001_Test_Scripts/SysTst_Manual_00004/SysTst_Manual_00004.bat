...
if not exist "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00004" mkdir "C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00004"
set LOG_FILE_ROOT="C:\Temp\MSV001\MSV001_Logs\SysTst_Manual_00004\SysTst_Manual_00004
:: Get date parts
...
echo Running test script SysTst_Manual_00004 from MSV001 test protocol
python "C:\Temp\MSV001\MSV001_Test_Scripts\SysTst_Manual_00004\SysTst_Manual_00004.py"
pause
