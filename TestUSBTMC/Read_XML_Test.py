...
def test_coding_language_selection(target_device):
    ...
    if(target_device == "dsPIC33CK128MP203"): 
        # LSC project - #C:\Temp\PM1_software_UUT_V1.1\LSC-v1.06\PM1-LSC-v1.06\PM1-LSC-v1.06\LSC_Firmware.X
        tree = ET.parse("C:/Temp/PM1_software_UUT_V1.1/LSC-v1.06/PM1-LSC-v1.06/PM1-LSC-v1.06/LSC_Firmware.X/nbproject/configurations.xml")
    elif (target_device == "PIC32MZ1024EFH100"):
        # PDA project - C:\Temp\PM1_software_UUT_V1.1\PDA-v1.14\PDA-v1.14\firmware\PDAB_Firmware.X
        tree = ET.parse("C:/Temp/PM1_software_UUT_V1.1/PDA-v1.14/PDA-v1.14/firmware/PDAB_Firmware.X/nbproject/configurations.xml")
    elif (target_device == "PIC24FJ64GA702"):
        # PE project - C:\Temp\PM1_software_UUT_V1.1\PE-v1.03\PM1-PE-v1.03\PE-Module\Environment-Firmware.X
        tree = ET.parse("C:/Temp/PM1_software_UUT_V1.1/PE-v1.03/PM1-PE-v1.03/PE-Module/Environment-Firmware.X/nbproject/configurations.xml")
    elif (target_device == "PIC32MZ2064DAR169"):
        # PI project - C:\Temp\PM1_software_UUT_V1.1\PI-v1.15\PI-v1.15\PIB_Firmware\firmware\PIB_Firmware.X
        tree = ET.parse("C:/Temp/PM1_software_UUT_V1.1/PI-v1.15/PI-v1.15/PIB_Firmware/firmware/PIB_Firmware.X/nbproject/configurations.xml")
    else:
