...
extern void test_RunThroughPostStatesUsingTwoInputLinesDrivenByIct(void);
extern void test_SkipPostAndGoToIdleIfTwoInputPinsAreConfiguredAsInNormalOperationMode(void);
...
int main(void)
{
  UnityBegin("test_HET_31.c");
  RUN_TEST(test_RunThroughPostStatesUsingTwoInputLinesDrivenByIct, 126);
  RUN_TEST(test_SkipPostAndGoToIdleIfTwoInputPinsAreConfiguredAsInNormalOperationMode, 186);
