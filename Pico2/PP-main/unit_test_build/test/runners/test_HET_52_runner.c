...
extern void test_WhenButtonIsNotPressedIndleTheTherapyIsStartedAfter60Minutes(void);
...
int main(void)
{
  UnityBegin("test_HET_52.c");
  RUN_TEST(test_WhenButtonIsNotPressedIndleTheTherapyIsStartedAfter60Minutes, 70);
