...
extern void test_DetectAnOutOfRangeVoltageDuringTherapyDeliveryGoIntoNRE(void);
...
int main(void)
{
  UnityBegin("test_HET_50.c");
  RUN_TEST(test_DetectAnOutOfRangeVoltageDuringTherapyDeliveryGoIntoNRE, 76);
