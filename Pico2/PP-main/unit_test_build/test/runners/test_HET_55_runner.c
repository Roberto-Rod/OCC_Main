...
extern void test_ShortBottonPressInTherapyDeliveryWhenAtTargetVacuunAndAlertTheUserEverythingIsOK(void);
...
int main(void)
{
  UnityBegin("test_HET_55.c");
  RUN_TEST(test_ShortBottonPressInTherapyDeliveryWhenAtTargetVacuunAndAlertTheUserEverythingIsOK, 73);
