...
extern void test_DuringIPDWhenTargetPressureIsNotAchievedTransitToFault(void);
...
int main(void)
{
  UnityBegin("test_HET_5.c");
  RUN_TEST(test_DuringIPDWhenTargetPressureIsNotAchievedTransitToFault, 74);
