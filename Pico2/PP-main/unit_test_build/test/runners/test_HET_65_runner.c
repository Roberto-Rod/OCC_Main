...
extern void test_SwitchTheDeviceOffWithLongButtonPressStartedInLeakErrorConditionAndDetectedInPumpDown(void);
...
int main(void)
{
  UnityBegin("test_HET_65.c");
  RUN_TEST(test_SwitchTheDeviceOffWithLongButtonPressStartedInLeakErrorConditionAndDetectedInPumpDown, 77);
