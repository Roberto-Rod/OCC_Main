...
extern void test_GoFromIdleToPumpDownAndClearTheWatchdogAtEveryExecution(void);
...
int main(void)
{
  UnityBegin("test_HET_13.c");
  RUN_TEST(test_GoFromIdleToPumpDownAndClearTheWatchdogAtEveryExecution, 66);
