function [AC_PC_thick, mean_med, pp, qq, weightedMean, wmSDE, mean_wt, valid, weight_to_report, thick_to_report]=main_convol_GK_cal2(filename,sheet,scan0,n,m,p, fit, plotFigures, peakFindType, cal, exp)
...
lookupname = 'C:\Users\JamesReynolds\Occuity Limited\Design - Documents\Working Area\P1-PP3 Build data\Optical Verification\Pheobe\7th July golden LDA\Pheobe, Flat 4 Degree, 7th July\Cal lookup.csv';
...
%    fprintf('%i\n', i);
    ...
    ACh(i) = max(ya(q1:q2));
        ...
        if peakFindType == 0
            ...
            [PCpos(i), PCheight(i), weight(i)]=find_all_peaks_jr4(ACind, posq, y, slope, 0, nc, resolution, 1);
...
[valid, mean_t, sd_t, median_t, madse_t, mean_w, sd_w, mean_wt, sd_wt, thick_to_report, weight_to_report] = find_thicknesses2(ACheight, ACpos, PCpos, weight, nc, exp, hampel, 1);
