function [ output_args ] = main_convol_calibrate2( data_folder_path,sheet,scan0,n,m,fit, plotFigures, peakFindType )
%
...
for j = 1 : length(data_filename)
    ...
    if (datamax > 5000) && (dataLH < datamax / 2) && (dataRH < datamax / 2)
        ...
        for i=2:n           % Loop along each block
            %i
