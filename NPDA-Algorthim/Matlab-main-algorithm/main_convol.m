function [AC_PC_thick, mean_med, time, pp]=main_convol(filename,sheet,scan0,n,m,fit)
...
%    end
    ...
    hold off
     ...
     % # ITEM2
     % 
    [PCpos(i),weight(i)]=findPC_max_jr(ACpos,posq,y,fit); %PC pos and quality of scan (weight)
    %pause
end
