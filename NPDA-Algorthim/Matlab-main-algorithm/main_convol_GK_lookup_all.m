function [AC_PC_thick, mean_med, pp, qq, weightedMean, wmSDE, mean_wt]=main_convol_GK_lookup_all(data_folder_path, lookupname, sheet,scan0,n,m,fit, plotFigures, peakFindType)
...
lookup0 = dlmread(char(lookupname), ',', 120, 0);
...
%       end
        ...
        %ACp1(i) = find(ya == max_1);
        %ACp2(i) = find(ya == max_2);
...
verify_file = strcat(data_folder_path, '\verification results test.csv');
