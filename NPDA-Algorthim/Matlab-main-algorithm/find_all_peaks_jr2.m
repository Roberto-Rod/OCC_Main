...
function [PCpos, PCht, weight]=find_all_peaks_jr2(indAC,pos,data,slopecorr, fit, nc, res)
...
%maxcct = 2.0;    % For software testing only
%maxcct = 0.65;  % For optical verification
