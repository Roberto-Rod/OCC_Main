function [mean_data, backshift] = Average_AC_align2(pos,data0, resolution, align)
...
for scan=1:nscans 
    ...
    maxpos = findAC_quad(temp_pos, temp, umres);
    %fprintf('%i\t%i\n', q1, q2);
    idx_true(scan) = find(abs(pos - maxpos) < umres); 
