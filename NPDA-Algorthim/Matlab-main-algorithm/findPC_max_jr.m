function [PCpos, PCheight, ref0]=findPC_max_jr(ACpos,pos,data,fit)
...
%outdata = [pospc, datapc];
%dlmwrite('scandata.csv', outdata, '-append');
...
%     
 ...
 if size(pks,1)>=2
    ...
    if size(PCidx0,1)==1   %There are no peaks on the left of PC
        ...
        ref0=pk_height(2);            % Another criteria for quality of scans
