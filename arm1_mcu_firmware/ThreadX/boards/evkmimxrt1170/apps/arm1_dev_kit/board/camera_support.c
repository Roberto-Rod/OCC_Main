...
static ov5640_resource_t ov5640Resource = {
    .i2cSendFunc      = I2C6_send_sccb,
    .i2cReceiveFunc   = I2C6_receive_sccb,
...
void BOARD_InitMipiCsi(void)
{
    ...
    {
        if ((FSL_VIDEO_RESOLUTION(CAMERA_WIDTH, CAMERA_HEIGHT) == csi2rxHsSettle[i][0]) &&
            (csi2rxHsSettle[i][1] == CAMERA_FRAME_RATE))
        {
