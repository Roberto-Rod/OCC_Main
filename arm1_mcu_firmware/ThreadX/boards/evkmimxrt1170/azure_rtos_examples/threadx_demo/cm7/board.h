...
#define BOARD_NAME "EA-IMXRT1176"

/* Select UART1 for CM7 core and UART6 for CM4 core */
...
#define USER_LED_INIT(output) do {} while(0)
#define USER_LED_ON()     PCA6416_ClearPins(PCA_RGB_LED_BLUE)
#define USER_LED_OFF()    PCA6416_SetPins(PCA_RGB_LED_BLUE)
#define USER_LED_TOGGLE() PCA6416_TogglePins(PCA_RGB_LED_BLUE)
...
#define BOARD_USER_BUTTON_NAME        "SW5/WAKEUP"
...
/*! @brief The ENET0 PHY address. PHY is on adapter board. */
#define BOARD_ENET0_PHY_ADDRESS (0x02U) /* Phy address of enet port 0. */

/*! @brief The ENET1 PHY address. PHY is on iMX RT1176 uCOM board. */
...
//#define BOARD_MIPI_PANEL_RST_GPIO   GPIO9    Controlled with PCA6416, PCA_LCD_DISP_MIPI_RST
//#define BOARD_MIPI_PANEL_RST_PIN    1
//#define BOARD_MIPI_PANEL_POWER_GPIO GPIO11   Controlled with PCA6416, PCA_LCD_BL_PWR
//#define BOARD_MIPI_PANEL_POWER_PIN  16
/* Back light pin. */
//#define BOARD_MIPI_PANEL_BL_GPIO GPIO9       Controlled with PCA9530, PCA9530_LED0
...
#define BOARD_MIPI_PANEL_TOUCH_RST_PIN           26
#define BOARD_MIPI_PANEL_TOUCH_INT_GPIO          GPIO3
#define BOARD_MIPI_PANEL_TOUCH_INT_PIN           25

/*! @brief The camera pins. */
#define BOARD_CAMERA_PWDN_GPIO GPIO9
#define BOARD_CAMERA_PWDN_PIN  14
...
/* Serial MWM WIFI */
#define BOARD_SERIAL_MWM_PORT_CLK_FREQ CLOCK_GetRootClockFreq(kCLOCK_Root_Lpuart7)
#define BOARD_SERIAL_MWM_PORT          LPUART7
#define BOARD_SERIAL_MWM_PORT_IRQn     LPUART7_IRQn
#define BOARD_SERIAL_MWM_RST_WRITE(output)

/* Bluetooth settings when using an M.2 module */
...
#define BOARD_BT_UART_DMA_RX_REQ  kDmaRequestMuxLPUART7Rx
#define BOARD_BT_UART_DMA_TX_REQ  kDmaRequestMuxLPUART7Tx
