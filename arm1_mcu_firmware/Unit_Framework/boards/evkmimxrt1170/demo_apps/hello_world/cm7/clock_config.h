...
#define BOARD_BOOTCLOCKRUN_ARM_PLL_CLK                996000000UL // Only true for commercial grade MCUs - it should be 798MHz for industrial version
...
#define BOARD_BOOTCLOCKRUN_SEMC_CLK_ROOT              148500000UL
