...
#endif
#ifndef BOARD_USER_CLK_GPIO_PIN
#define BOARD_USER_CLK_GPIO_PIN (12U)
#endif
...
#define USER_CLK_INIT(output)                                            \
    GPIO_PinWrite(BOARD_USER_LED_GPIO, BOARD_USER_CLK_GPIO_PIN, output); \
    BOARD_USER_LED_GPIO->GDIR |= (1U << BOARD_USER_CLK_GPIO_PIN)
#define USER_CLK_OFF() \
    GPIO_PortClear(BOARD_USER_LED_GPIO, 1U << BOARD_USER_CLK_GPIO_PIN)                 /*!< Turn off target USER_CLK */
#define USER_CLK_ON() GPIO_PortSet(BOARD_USER_LED_GPIO, 1U << BOARD_USER_CLK_GPIO_PIN) /*!<Turn on target USER_CLK */
