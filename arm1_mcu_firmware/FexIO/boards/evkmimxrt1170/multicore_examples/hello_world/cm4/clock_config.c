...
void UpdateSemcClock(void)
{
    ...
    */
    CCM->CLOCK_ROOT[kCLOCK_Root_Semc].CONTROL = 0x603;
}
#endif
#endif
...
void BOARD_BootClockRUN(void)
{
    ...
    */
    /* Init Arm Pll. For boards with industrial rating, lower divider to get
       798MHz instead of 996MHz core clock. */
    if (*((uint32_t*)0x40cac960) & 0x8) {
        armPllConfig_BOARD_BootClockRUN.loopDivider = 133;
    }
    ...
    rootCfg.div = 4; /* 4 => 148.5MHz SEMC CLK */
