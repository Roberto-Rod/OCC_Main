...
// this persistent memory location is used to detect if reset came from bootloader or application firmware
unsigned long  MagicNumber  __attribute__((persistent));
...
static bool EnterBootloadMode(void)
{
    ...
    // enter bootloader if micro has software reset
//    if (RCONbits.SWR)
//    {
//        if (MagicNumber==1664)
//        {  
//            MagicNumber=0;   //clear flag for next time
//            return false;    //restart from bootloader, ignore
//        }
//        return true;
//    }
    
    /* testing DSP_BUSY line from EFH */
    uint32_t j;
