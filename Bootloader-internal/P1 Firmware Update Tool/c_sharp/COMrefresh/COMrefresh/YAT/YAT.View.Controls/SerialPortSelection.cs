...
// ------------------------------------------------------------------------------------------------
// $URL: file:///svn/p/y-a-terminal/code/trunk/YAT/YAT.View.Controls/SerialPortSelection.cs $
// $Revision: 3786 $
	...
	////is not required since  "  _Validating() below gets called anyway.
		...
		private void SetPortList()
		{
			...
			if (Enabled && Visible && !DesignMode)
			{
				...
				{
                    bool retrieveCaptions = true;// ApplicationSettings.LocalUserSettings.General.RetrieveSerialPortCaptions;
                    bool detectPortsInUse = true;// ApplicationSettings.LocalUserSettings.General.DetectSerialPortsInUse;
