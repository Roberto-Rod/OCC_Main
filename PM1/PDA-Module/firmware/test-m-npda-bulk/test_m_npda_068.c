...
#include "test_m_npda_SBL-2020-09-18-10-45-32-15-300-Raw_cal_02.h"
#include "npda.h"
 ...
 *                   data and calibration from test_m_npda_SBL-2020-09-18-10-45-32-15-300-Raw_cal_02.h.
 *
 * @note             None
 */
/* ************************************************************************** */
void test_npda_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02(void)
{
    int iret;
    _SCAN_BUFFER result;
    unsigned int time;
    ...
    unity_helper_tic();
    iret = run_npda( &scanData_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02, &result, cal_data_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02 );
    ...
    UnityPrint(", iret: "); UnityPrintNumber(iret); UnityPrint(" vs "); UnityPrintNumber(expected_iret_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02);
    UnityPrint(", Thickness: "); UnityPrintFloat(CORNEA_REFRACTIVE_IDX*result.Header.Measurement.Separation[0]); UnityPrint(" vs "); UnityPrintFloat(expected_cor_thickness_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02);
    UnityPrint(", Precision: "); UnityPrintFloat(CORNEA_REFRACTIVE_IDX*result.Header.Measurement.Precision[0]); UnityPrint(" vs "); UnityPrintFloat(expected_cor_thickness_acuracy_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02);
    UnityPrint(", Blocks: "); UnityPrintFloat(result.Header.Blocks); UnityPrint(" vs "); UnityPrintFloat(expected_valid_blocks_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02);

    TEST_ASSERT_EQUAL_INT(expected_iret_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02, iret);
    if(expected_iret_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02 != ERROR_TOO_FEW_BLOCKS && expected_iret_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02 != ERROR_PC_PEAKS_TOO_SMALL && expected_iret_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02 != ERROR_SPREAD_TOO_HIGH) {
        TEST_ASSERT_FLOAT_WITHIN(0.1, expected_cor_thickness_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02, CORNEA_REFRACTIVE_IDX*result.Header.Measurement.Separation[0]);
        TEST_ASSERT_FLOAT_WITHIN(0.1, expected_cor_thickness_acuracy_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02, CORNEA_REFRACTIVE_IDX*result.Header.Measurement.Precision[0]);
        TEST_ASSERT_EQUAL_INT(expected_valid_blocks_SBL_2020_09_18_10_45_32_15_300_Raw_cal_02, result.Header.Blocks);
   }
}
