...
extern void test_DetectAnOutOfRangeVoltageDuringPumpDownGoIntoNRE(void);
...
int main(void)
{
  UnityBegin("test_HET_59.c");
  RUN_TEST(test_DetectAnOutOfRangeVoltageDuringPumpDownGoIntoNRE, 76);
