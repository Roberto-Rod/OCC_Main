...
extern void test_InIdleStateWhenNoButtonIsPressedGoToLowPowerDisablingPeripherals(void);
...
int main(void)
{
  UnityBegin("test_HET_7.c");
  RUN_TEST(test_InIdleStateWhenNoButtonIsPressedGoToLowPowerDisablingPeripherals, 71);
