...
extern void test_FailToReadVacuumInTherapyDeliveryAndAlertTheUserOfTheErrorConditionAndEnterNRE(void);
...
int main(void)
{
  UnityBegin("test_HET_82.c");
  RUN_TEST(test_FailToReadVacuumInTherapyDeliveryAndAlertTheUserOfTheErrorConditionAndEnterNRE, 79);
