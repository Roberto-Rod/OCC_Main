...
extern void test_AlertTheUserAccordingToACompositeLedFlashinPatternWhenTargetPressureIsReachedAndBeyond(void);
...
int main(void)
{
  UnityBegin("test_HET_44.c");
  RUN_TEST(test_AlertTheUserAccordingToACompositeLedFlashinPatternWhenTargetPressureIsReachedAndBeyond, 94);
