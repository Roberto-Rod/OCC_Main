...
extern void test_TurnOffDeviceDuringIPDWhenPushButtonIsHeldForTwoSeconds(void);
extern void test_DeviceCanBeTurnedOffDuringMPD(void);
...
int main(void)
{
  UnityBegin("test_HET_24.c");
  RUN_TEST(test_TurnOffDeviceDuringIPDWhenPushButtonIsHeldForTwoSeconds, 66);
  RUN_TEST(test_DeviceCanBeTurnedOffDuringMPD, 176);
