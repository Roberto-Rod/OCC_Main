...
extern void test_VerifyNREStateIsEnteredWhenNRErrorRaisedInIdle(void);
extern void test_VerifyNREStateIsEnteredWhenNRErrorRaisedInTherapy(void);
...
int main(void)
{
  UnityBegin("test_HET_83.c");
  RUN_TEST(test_VerifyNREStateIsEnteredWhenNRErrorRaisedInIdle, 89);
  RUN_TEST(test_VerifyNREStateIsEnteredWhenNRErrorRaisedInTherapy, 113);
