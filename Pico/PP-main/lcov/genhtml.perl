...
# Added by RR to solve "'pwd' is not recognized as an internal or external command,"
use Cwd qw(cwd);
...
our $cwd = cwd;    # Current working directory, changed by RR
print "Current working directory: $cwd\n";
chomp($cwd);
print "Current working directory after chomping: $cwd\n";
...
sub gen_html()
{
    ...
    foreach $dir_name (@dir_list)
    {
        ...
        if (!$no_prefix && $dir_prefix)
        {
            ...
            print "directory name $dir_name : 0directory prefix : $dir_prefix\n";
        }
...
sub process_dir($)
{
    ...
    if (!$no_prefix)
    {
        ...
        print "1relative directory $rel_dir : 1directory prefix : $dir_prefix\n";
    }
...
sub create_sub_dir($)
{
    ...
    opendir(DIR, $dir) || mkdir($dir,0777) || die "Cannot create directory $dir; $!";
